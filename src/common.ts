...
export class FileEntry {
    ...
    */
    static readEntries(filename: string, fileHeader: FileHeader, buffer: Uint8Array, keySalt?: string[]): FileEntry[] {
        let headerOffset = encryption.generateHeaderOffset(filename)
...
function testKeySalt(filename: string, buffer: Uint8Array): string[] {
    let keySalt: string[] = []
    let headerOffset = encryption.generateHeaderOffset(filename)
